...
) RETURNING id, name, description, host_id, slot, available_slot, price, status, start_at, end_at, created_at, updated_at
`
...
SELECT id, name, description, host_id, slot, available_slot, price, status, start_at, end_at, created_at, updated_at FROM tour
WHERE id = $1 LIMIT 1
`
...
SET
    available_slot = $2,
    updated_at = NOW()
WHERE id = $1 RETURNING id, name, description, host_id, slot, available_slot, price, status, start_at, end_at, created_at, updated_at
`
