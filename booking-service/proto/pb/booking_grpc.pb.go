...
type BookingServiceClient interface {
	UpdateBookingStatus(ctx context.Context, in *BookingReq, opts ...grpc.CallOption) (*BookingResp, error)
}
...
func (c *bookingServiceClient) UpdateBookingStatus(ctx context.Context, in *BookingReq, opts ...grpc.CallOption) (*BookingResp, error) {
...
type BookingServiceServer interface {
	UpdateBookingStatus(context.Context, *BookingReq) (*BookingResp, error)
...
func (UnimplementedBookingServiceServer) UpdateBookingStatus(context.Context, *BookingReq) (*BookingResp, error) {
...
func _BookingService_UpdateBookingStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).UpdateBookingStatus(ctx, req.(*BookingReq))
	}
