...
import SaveIcon from '../../assets/icons/taskbar/heart.svg';
import SaveOutlineIcon from '../../assets/icons/taskbar/heart-outline.svg';
...
const TaskBar: React.FC<BottomTabBarProps> = ({ state, navigation }) => {
