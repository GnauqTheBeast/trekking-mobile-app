...
const ChangeEmailOTPScreen:React.FC = () => {

    const auth = useContext(AuthContext)!;
    const {setUser, setToken, setIsLoggedIn} = auth;
    ...
    const verifyOtp = async() => {
        ...
        try {
            ...
            await axios.post('http://10.0.2.2:3001/auth/change-email/otp', {
                email,
                otp: enteredOtp
            })
            ...
            Alert.alert("Success", "Email changed successfully, please log in again.")
